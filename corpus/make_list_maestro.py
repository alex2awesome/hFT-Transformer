...
if __name__ == '__main__':
    ...
    for i in range(1, len(a_in)):
        ...
        # -i $CURRENT_DIR/corpus/MAESTRO-V3/maestro-v3.0.0/maestro-v3.0.0.csv
        fpath_wav = os.path.join(os.path.dirname(args.i), fname_wav)
        fpath_mid = os.path.join(os.path.dirname(args.i), fname_mid)
        if os.path.exists(fpath_wav) and os.path.exists(fpath_mid):
            # if 'MIDI-Unprocessed_12_R1_2006_01-08_ORIG_MID--AUDIO_12_R1_2006_04_' in fname_mid:
            #     print('file found')
            ...
            print('file not found: ' + fname_wav + ' or ' + fname_mid)
